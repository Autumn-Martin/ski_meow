...
const resorts = ['keystone','steamboat','loveland','aspen','crested_butte','telluride']
  ...
  $(`#weatherPage`).append(`
    ...
    <div class='col-container'>
      ...
      <div id='bColumnInfo' class='col'>
        <p class='cloudCover'>cloud cover: <span style='float:right'>${weather.cloudCover}%</span></p>
        <p class='visibility'>visibility: <span style='float:right'>${weather.visibility}</span></p>
        <p class='windSpeed'>wind speed: <span style='float:right'>${weather.windSpeed}</span></p>
      </br>
