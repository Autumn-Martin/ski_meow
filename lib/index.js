  ...
  $(`#weatherPage`).append(`
    ...
    <div class='col-container'>
      ...
      <div id='bColumnInfo' class='col'>
        <p class='cloudCover'>42% cloudy</p>
        <p class='visibility'>10 mi visibility</p>
        <p class='windSpeed'>2 mph wind</p>
      </br>
        <p class='mtnPeakTemp'>10</p>
        <p>at mountain peak</p>
        <p class='midChairTemp'>20</p>
        <p>at mid chair</p>
        <p class='mtnBaseTemp'>30</p>
